...
def check_form_and_alarm():
    try:
        ...
        form_exists = selector.css('#appointment_newAppointmentForm').get() is not None
        if form_exists:
            logging.info("Form found! Playing alarm sound...")
            ...
            logging.info("!!!!!!!!! The Appointment is Now Open !!!!!!!!!!!")
            return False
